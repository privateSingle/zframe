...
(function ($) {
    ...
    var PageGrid = {
        ...
        /**渲染表格数据 by zhangyantao 2017/6/21*/
        ...
        /**跳到分页页面 by zhangyantao 2017/6/22*/
        toPage: function (R,obj, $grid, url) {
            defaultParam.page = obj.curr;
            /**增加每页显示条数 by zhangyantao 2017/08/21*/
            defaultParam.limit = obj.limit;
            //写入页面中，作为导出参数
            $("#page").val(obj.curr);
            $("#limit").val(obj.limit);
            /**解决列表页两次请求后台问题 by zhangyantao 2018/01/02*/
            //是否是首次加载列表
        ...
        /**表格排序 by zhangyantao 2018/01/03*/
        ,sort:function () {
            $("[zType='pageGrid']").on("click","th",function () {
