...
<head>
    ...
    <script type="text/javascript" src="/zframe/sysoss/js/list.js"></script>
</head>
<body>
...
<div class="layui-form nowrap">
    <table class="layui-table" id="sysOssTable" zType="pageGrid"
           zProps="url:'/sysoss/listData',checkbox:'true',pageColor:'#2991d9'">
        <thead>
        <tr>
            <!--复选框-->
