 ...
 */
package platform.zframe.common.support.office.word.render;
...
import platform.zframe.common.support.office.word.el.ELObject;
import platform.zframe.common.support.office.word.exception.RenderException;
import platform.zframe.common.support.office.word.policy.DocxRenderPolicy;
import platform.zframe.common.support.office.word.policy.RenderPolicy;
import platform.zframe.common.support.office.word.template.ElementTemplate;
import platform.zframe.common.support.office.word.util.ObjectUtils;
...
public class RenderAPI {
	...
	public static void render(DocBoot template, Object dataModel) {
	...
	private static void doRender(ElementTemplate ele, ELObject model, RenderPolicy policy, DocBoot template) {
	 ...
	 * @param template
	 */
	public static void selfRender(DocBoot template) {
		ObjectUtils.requireNonNull(template, "Template is null, should be setted first.");
		List<ElementTemplate> elementTemplates = template.getElementTemplates();
		if (null == elementTemplates || elementTemplates.isEmpty())
			return;
	...
	@Deprecated
	public static void debug(DocBoot template, Map<String, Object> datas) {
